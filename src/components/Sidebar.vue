<template>
	<div class="sidebar">
		...
		<ul class="nav side-menu">
			<li v-for="(menu, index) in menus" :key="index" :data-link="menu.link">
				<router-link :to="menu.link">
					<i class="czs" v-bind:class="menu.pic"></i>{{menu.title}}
					<span class="icon" v-show="!menu.link" v-bind:class="menu.class ? 'fa-chevron-down' : 'fa-chevron-right'"></span>
				</router-link>
			</li>
		</ul>
		<div class="weixin">
